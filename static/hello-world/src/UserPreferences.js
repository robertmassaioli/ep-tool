    ...
    <div>
      ...
      {effectiveSetting && (
        <div style={{ 
          marginBottom: '30px', 
          padding: '15px', 
          backgroundColor: effectiveSetting.enabled ? '#e3fcef' : '#ffebe6', 
          borderRadius: '4px',
          border: `2px solid ${effectiveSetting.enabled ? '#00875A' : '#DE350B'}`
        }}>
          <h4 style={{ margin: 0, marginBottom: '8px', color: effectiveSetting.enabled ? '#00875A' : '#DE350B' }}>
